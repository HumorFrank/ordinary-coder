...
<template>
  <div class="linux-fs-demo">
    ...
    <div class="tree">
      <div v-for="dir in dirs" :key="dir.path" :class="['dir-item', { active: activeDir === dir.path }]"
...
const dirs = [
  { path: '/', icon: '📁', brief: '根目录', desc: '整个文件系统的起点，所有目录和文件都从这里开始，所有设备、进程信息都以文件形式存在于这棵目录树中。', examples: [] },
