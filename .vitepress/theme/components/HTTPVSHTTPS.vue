<template>
  <div class="comparison-demo">
    ...
    <div class="control-row">
      <button class="mode-btn" :class="{ active: mode === 'http' }" @click="mode = 'http'">
        HTTP（明文）
      </button>
      <button class="mode-btn https" :class="{ active: mode === 'https' }" @click="mode = 'https'">
        HTTPS（加密）
      </button>
    ...
    <div class="flow-area">
      ...
      <div class="transmission">
        <div class="wire" :class="mode">
          ...
          <div class="packet" :class="{ moving: isSending, done: sendDone }">
