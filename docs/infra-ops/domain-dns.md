...
1. **根证书（Root CA）**：由受信任的证书颁发机构签发，预装在操作系统和浏览器中，是信任的"锚点"。
...
- [域名、DNS 与 HTTPS](https://datawhalechina.github.io/easy-vibe/zh-cn/appendix/7-infrastructure-and-operations/dns-https.html)
