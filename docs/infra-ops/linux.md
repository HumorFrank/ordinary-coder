...
- **命令组合**：单个命令功能简单，通过管道 `|` 组合才能发挥真正威力
- **权限模型**：Owner/Group/Others × Read/Write/Execute，用数字（如 755）快速设置
...
## 参考资料
- [Linux 基础](https://datawhalechina.github.io/easy-vibe/zh-cn/appendix/7-infrastructure-and-operations/linux-basics.html)